    ...
    for row in results:
        ...
        for ar in as_list(r.get('agentRuns')):
            ...
            agent_outputs.append({
                ...
                'generation_provider': clean(as_dict(r.get('llm_experiment')).get('provider') or llm.get('provider')),
                'generation_model': clean(as_dict(r.get('llm_experiment')).get('model') or llm.get('model')),
