...
def main(argv: list[str] | None = None) -> int:
    ap = argparse.ArgumentParser(description='Summarize live-LLM WCCU ablation tables across review-grade runs.')
    ...
    lines = ['# Review-grade live-LLM run summary', '', f'Input tables: `{args.glob}`', '', f'Rows: {len(rows)}', '']
